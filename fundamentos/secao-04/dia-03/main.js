...
function addClass(event) {
  ...
  clickedElement.classList.add('tech');
}
...
function textBoxTech(event) {
  event.target.classList.add('tech'); 
}

inputElement.addEventListener('input', textBoxTech);
...
elementToClick = document.getElementById('my-spotrybefy')

function goToLink() {
  window.location.replace('google.com')
}

elementToClick.addEventListener('dblclick', goToLink)
...
elementToClick.addEventListener('mouseover', changeColor)
elementToClick.addEventListener('mouseout', revertColor)
